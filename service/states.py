...
class Admin(metaclass=StateMeta):
    ...
    PUBLIC_FORM_BOARD = "public_form_board"
    REASON_DELETE_FORM = "reason_del_form"
    CABIN_CHAT_DECISION = "cabin_chat_decision"
    ...
    MANDATORY_QUEST_NAME = 'mandatory_quest_name'
    MANDATORY_QUEST_FORM_IDS = 'mandatory_quest_form_ids'
...
class Judge(metaclass=StateMeta):
    ...
    SET_CONSEQUENCES = 'set_consequences'
    SELECT_USER_TO_PASS = 'select_user_to_pass'
    FORCE_QUEST_TARGETS = 'force_quest_targets'
    FORCE_QUEST_NAME = 'force_quest_name'
...
class Auction(metaclass=StateMeta):
    ...
    SELECT_TEMPLATE = 'auction_select_template'
...
class FormSecrets(metaclass=StateMeta):
    ...
    ENTER_ACCESS_USERS = 'secret_access_users'
