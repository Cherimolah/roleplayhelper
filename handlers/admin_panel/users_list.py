"""
Модуль для работы со списками пользователей и администраторов.
Содержит функции для просмотра пользователей и управления правами доступа.
"""
...
async def send_users(m: Message):
    """Отправка списка пользователей (первая страница)"""
...
async def change_page_users(m: MessageEvent):
    """Обработка переключения страниц списка пользователей"""
...
async def send_administrators(m: Message):
    """Отображение панели управления администраторами и судьями"""
